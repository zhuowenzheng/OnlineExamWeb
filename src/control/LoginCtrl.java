        ...
        if (ac.equals("login")) {
            ...
            if (!pagerandom.equals(random) && request.getParameter("a") != null) {
                ...
                String sql1 = "";
                 ...
                 if (utype.equals("学生")) {sql1 = "select * from xuesheng where xuehao='" + username + "' and mima='" + password + "' "; } 
        ...
        if (ac.equals("adminlogin")) {
            ...
            if (!pagerandom.equals(random) && request.getParameter("a") != null) {
                ...
                String sql1 = "";
                 ...
                 if (utype.equals("管理员")) {sql1 = "select * from admins where zhanghao='" + username + "' and mima='" + password + "' "; } 
        ...
        if (ac.equals("adminuppass")) {
            ...
            if (m == null || m.isEmpty()) {
                ...
                String sql = "";
                 ...
                 if (cx.equals("管理员")) {
                    sql = "UPDATE admins SET mima='" + userpass + "' WHERE zhanghao='" + username + "'";
                }
