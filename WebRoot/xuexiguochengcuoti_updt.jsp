...
<script src="js/jquery.validate.js"></script>
 ...
 HashMap mmm = new CommDAO().getmap(request.getParameter("id"), "xuexiguochengcuoti");%>
...
<div style="padding: 10px" class="admin-content">
    ...
    <div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑 学习过程错题:</div>
            <div class="panel-body">
       <form action="xuexiguochengcuoti.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
 ...
 <input type="hidden" id="lianxitimu" name="lianxitimu" value="<%= Info.html(mmm.get("lianxitimu")) %>" />
                    ...
                    <div class="form-group" >
                        <div class="row">
                            ...
                            <%HashMap mapsuoshuzhangjie424 = new CommDAO().find("SELECT zhangjiemingchen FROM zhangjie where id='"+ mmm.get("suoshuzhangjie") + "'");%>
 <%= mapsuoshuzhangjie424.get("zhangjiemingchen") %> <input type="hidden" id="suoshuzhangjie" name="suoshuzhangjie" value="<%= Info.html(mmm.get("suoshuzhangjie")) %>" />
                    ...
                    <div class="form-group" >
                        <div class="row">
                            ...
                            <textarea style="width:80%;height:150px;max-width:90%;min-height:120px" class="form-control" palaceholder="输入字母"  id="zimu"   name="zimu"   ><%=Info.html(mmm.get("zimu"))%></textarea>
                    ...
                    <div class="form-group" >
                        <div class="row">
                            ...
                            <textarea style="width:80%;height:150px;max-width:90%;min-height:120px" class="form-control" palaceholder="输入正确答案"  id="zhengquedaan"   name="zhengquedaan"   data-rule-required="true" data-msg-required="请填写正确答案" ><%=Info.html(mmm.get("zhengquedaan"))%></textarea>
