...
<select class="form-control class_suoshuzhangjie425" name="suoshuzhangjie" id="suoshuzhangjie" data-value="<%=request.getParameter("suoshuzhangjie") !=null ? request.getParameter("suoshuzhangjie") :""%>"  style="width:250px;" >
<option value>请选择所属章节</option>
<%List<HashMap> select425 = new CommDAO().select("SELECT * FROM zhangjie ORDER BY id desc");%>
<% for (HashMap m : select425) { %><option value="<%= m.get("id") %>" readonly><%= m.get("zhangjiemingchen") %></option>
<% } %>
</select>
...
<select class="form-control class_leixing427" name="leixing" id="leixing" data-value="<%=request.getParameter("leixing") !=null ? request.getParameter("leixing") :""%>"  style="width:250px;" >
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        <td width="30" align="center"><label><%= i %></label></td>
                            ...
                            <td><%HashMap mapsuoshuzhangjie425 = new CommDAO().find("SELECT zhangjiemingchen FROM zhangjie where id='"+ map.get("suoshuzhangjie") + "'");%>
 <%= mapsuoshuzhangjie425.get("zhangjiemingchen") %></td>
